...
This repo is created for sharing the codes for the paper, *Learning Incident Prediction Models Over Large GeographicalAreas for Emergency Response Systems*, sumbitted to KDD. Figure below shows the general pipeline designed by authors. 
